...
public class TextEditor extends javax.swing.JFrame {
    ...
    /**
     * Gets the hex code for one of 15 aesthetic colors.
     * @param n the index of the color
     * @return string containing the hex color
     */
    ...
    /**
     * Prompts the user for new corpus and tagset files.
     * If the user provides invalid files, loads files
    ...
    /**
     * Handles the selection and dictionary lookups when
     * the user clicks on a tagged word.
     */
    ...
    /**
     * Opens a text file and inserts its contents
    ...
    /**
     * Saves the contents of the text editor as a file.
     */
    ...
    /**
     * Runs the viterbi algorithm on the contents of
     * the text editor, then colors and displays
     * the results.
     */
